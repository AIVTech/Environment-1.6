...
public class FpsCamera {
	...
	private float runningSpeed = 40;
	private float crouchDistance = 4.2f;
	...
	// terrain information for collision detection
	private Terrain[][] terrainGrid;

	public FpsCamera(Terrain[][] terrainGrid) { 
		yaw += 115;
	...
	public void update() {
		...
		// Jumping
		Terrain terrain = getTerrain(position.x, position.z);
