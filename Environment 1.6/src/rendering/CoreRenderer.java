...
public class CoreRenderer {
	...
	public void renderScene(List<Entity> entities, List<Terrain> terrains, FpsCamera camera, List<Light> lights) {
	...
	public void render(FpsCamera camera, List<Light> lights) {
		prepare();
